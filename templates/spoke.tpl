...
ios-config-60="ip nat inside source static tcp ${consul_ip} 22 interface GigabitEthernet1 2022"
ios-config-61="ip nat inside source static tcp ${consul_ip} 8500 interface GigabitEthernet1 8500"
