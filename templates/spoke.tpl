...
ios-config-40=" ip nhrp map ${hub_tunnel_ip} ${hub_public_ip}"
ios-config-41=" ip nhrp nhs ${hub_tunnel_ip}"
ios-config-42=" ip nhrp authentication ${nhrp_authentication_key}"
ios-config-43=" ip nhrp network-id 100"
ios-config-44=" ip nhrp holdtime 60"
ios-config-45=" ip tcp adjust-mss 1360"
ios-config-46=" tunnel source GigabitEthernet1"
ios-config-47=" tunnel destination ${hub_public_ip}"
ios-config-48=" tunnel key ${tunnel_key}"
ios-config-49=" tunnel protection ipsec profile vpnprofile shared "
ios-config-50="interface GigabitEthernet2"
ios-config-51=" no shutdown"
ios-config-52=" ip address dhcp"
ios-config-53=" ip nat inside"
ios-config-54="interface GigabitEthernet1"
ios-config-55=" ip nat outside"
ios-config-56="router eigrp 100"
ios-config-57=" no auto-summary"
ios-config-58=" redistribute static"
ios-config-59=" network 10.0.0.0 0.255.255.255"
ios-config-60=" network 192.168.1.0 0.0.0.255"
ios-config-61="ip nat inside source static tcp ${consul_ip} 22 interface GigabitEthernet1 2022"
ios-config-62="ip nat inside source static tcp ${consul_ip} 8500 interface GigabitEthernet1 8500"
ios-config-63="ip route ${internal_route} ${vpc_router}
